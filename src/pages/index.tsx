  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Doctor Appointment System - Your one-stop solution for scheduling, managing, and tracking your healthcare appointments seamlessly and efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Doctor Appointment System - Your one-stop solution for scheduling, managing, and tracking your healthcare appointments seamlessly and efficiently.`}
            </Text>
            <Box
