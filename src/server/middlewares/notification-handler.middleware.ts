...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Appointment Scheduled.create': {
    roles: ['administrator', 'doctor', 'nurse', 'receptionist'],
    key: 'appointment_scheduled',
    tenantPath: [],
    userPath: [],
  },
  'Prescription Issued.create': {
    roles: ['administrator', 'doctor', 'nurse', 'receptionist'],
    key: 'prescription_issued',
    tenantPath: [],
    userPath: [],
  },
  'Medical Record Updated.update': {
    roles: ['administrator', 'doctor', 'nurse', 'receptionist'],
    key: 'medical_record_updated',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'doctor', 'nurse', 'receptionist', 'patient'];
